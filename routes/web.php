...
Route::get('phone_book/edit/{id}', [PhoneBookController::class, 'edit'])->name('phone_book.edit');


Route::get('phone_book/{id}', [PhoneBookController::class, 'show'])->name('phone_book.show');

Route::put('phone_book/{id}/update', [PhoneBookController::class, 'update'])->name('phone_book.update');